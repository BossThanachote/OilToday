...
OilToday! บอทผู้ช่วยส่วนตัวบนแอปพลิเคชัน LINE ที่จะทำให้การเช็คราคาน้ำมันเป็นเรื่องง่ายและรวดเร็ว เพียงแค่กดเมนู ระบบจะดึงข้อมูลราคาน้ำมันล่าสุดเปรียบเทียบแต่ละปั๊ม มาแสดงผลในรูปแบบการ์ดที่สวยงามและอ่านง่าย ตอบโจทย์คนใช้รถที่ต้องการความรวดเร็ว
...
*(สแกน QR Code หรือค้นหาด้วย Line ID เพื่อเริ่มต้นใช้งานได้ทันที)*

---

## ✨ Features

- **Automated Flex Message:**  (Flex Message) แสดงผลชัดเจน เรียงลำดับราคาจากถูกไปแพงให้ดูเปรียบเทียบได้ง่ายๆ
- **Interactive Rich Menu:** ผู้ใช้สามารถกด "เช็คราคาน้ำมัน", "เปิดเว็บไซต์" หรือ "ติดต่อผู้พัฒนา" ได้ทันทีโดยไม่ต้องพิมพ์คำสั่ง
...
- **Zero-Cost Architecture:** ออกแบบระบบให้ใช้ Reply Token ของ LINE ร่วมกับ Serverless API ทำให้ส่งข้อความตอบกลับได้
